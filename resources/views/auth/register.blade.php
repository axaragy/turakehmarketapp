          ...
          <div class="col-lg-4">
            ...
            <form class="mt-3">
              <div class="form-group">
                ...
                <input type="text" name="fullname" id="fullname" class="form-control is-valid" v-model="name" autofocus>
              </div>
              <div class="form-group">
              ...
              <a href="/dashboard.html" class="btn btn-success btn-block mt-5">
                Sign Up Now
              </a>
